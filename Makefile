...
$(USER_BUILD_DIR)/mouse.o: user/mouse.c | directories
	$(CC) -c $< -o $@ $(USER_CFLAGS) $(USER_CPPFLAGS)

$(USER_BUILD_DIR)/mouse.elf: $(USER_BUILD_DIR)/crt0.o $(USER_BUILD_DIR)/mouse.o $(LIBC_USER_ARCHIVE) user/linker.ld | directories
	$(CC) -T user/linker.ld -o $@ $(USER_BUILD_DIR)/crt0.o $(USER_BUILD_DIR)/mouse.o $(LIBC_USER_ARCHIVE) -ffreestanding -fno-pie -nostdlib -nostartfiles -Wl,-n

$(USER_BUILD_DIR)/mouse_blob.o: $(USER_BUILD_DIR)/mouse.elf | directories
	$(LD) -r -m elf_i386 -b binary $< -o $@

$(USER_BUILD_DIR)/about.o: user/about.c | directories
	$(CC) -c $< -o $@ $(USER_CFLAGS) $(USER_CPPFLAGS)

$(USER_BUILD_DIR)/about.elf: $(USER_BUILD_DIR)/crt0.o $(USER_BUILD_DIR)/about.o $(LIBC_USER_ARCHIVE) user/linker.ld | directories
	$(CC) -T user/linker.ld -o $@ $(USER_BUILD_DIR)/crt0.o $(USER_BUILD_DIR)/about.o $(LIBC_USER_ARCHIVE) -ffreestanding -fno-pie -nostdlib -nostartfiles -Wl,-n

$(USER_BUILD_DIR)/about_blob.o: $(USER_BUILD_DIR)/about.elf | directories
	$(LD) -r -m elf_i386 -b binary $< -o $@

$(USER_BUILD_DIR)/dean.o: user/dean.c | directories
	$(CC) -c $< -o $@ $(USER_CFLAGS) $(USER_CPPFLAGS)

$(USER_BUILD_DIR)/dean.elf: $(USER_BUILD_DIR)/crt0.o $(USER_BUILD_DIR)/dean.o $(LIBC_USER_ARCHIVE) user/linker.ld | directories
	$(CC) -T user/linker.ld -o $@ $(USER_BUILD_DIR)/crt0.o $(USER_BUILD_DIR)/dean.o $(LIBC_USER_ARCHIVE) -ffreestanding -fno-pie -nostdlib -nostartfiles -Wl,-n

$(USER_BUILD_DIR)/dean_blob.o: $(USER_BUILD_DIR)/dean.elf | directories
	$(LD) -r -m elf_i386 -b binary $< -o $@
