...
USER_ELFS = $(USER_BUILD_DIR)/anim.elf $(USER_BUILD_DIR)/forktest.elf $(USER_BUILD_DIR)/execvetest.elf $(USER_BUILD_DIR)/waittest.elf $(USER_BUILD_DIR)/waitstress.elf $(USER_BUILD_DIR)/waitstressbg.elf $(USER_BUILD_DIR)/catfd.elf $(USER_BUILD_DIR)/sigtest.elf $(USER_BUILD_DIR)/mmaptest.elf $(USER_BUILD_DIR)/shmtest.elf $(USER_BUILD_DIR)/nxstacktest.elf $(USER_BUILD_DIR)/randtest.elf $(USER_BUILD_DIR)/argvtest.elf $(USER_BUILD_DIR)/syscalltest.elf $(USER_BUILD_DIR)/fstest.elf $(USER_BUILD_DIR)/dmesgtest.elf $(USER_BUILD_DIR)/blktest.elf $(USER_BUILD_DIR)/nettest.elf
